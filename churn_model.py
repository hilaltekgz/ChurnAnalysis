...
data_path=(r'C:\Users\hlltk\PycharmProjects\churn_analysis\churn_data_modified.csv')
df = pd.read_csv(data_path)
del df['ıd']
del df['InternetService#No']
print(df.shape)
...
print(y)
print('Tenure ve Churn cor :',df['tenure'].corr(df['Churn']))
import pandas as pd
import numpy as np
...
y_pred_rfc = (rfc_best.predict_proba(X_test)[:,1] >= 0.3).astype(bool) #set threshold as 0.3
